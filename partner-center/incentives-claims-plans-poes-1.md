...
Este tópico ajudará você a entender o processo de declarações de cooperação, incluindo prazos e tempos de pagamento. Você também aprenderá a criar e enviar um plano e uma verificação de execução (PoE).
...
## <a name="co-op-claims"></a>Declarações de cooperação

### <a name="claims-approval-and-payment-deadlines"></a>Aprovação de declarações e prazos de pagamento

#### <a name="when-will-my-co-op-claim-be-approved"></a>Quando minha declaração de cooperação será aprovada

As declarações de cooperação são examinadas em dois dias úteis após o envio. Depois que forem consideradas válidas, elas são definidas como status Aprovado.  

A seguir estão os vários status possíveis para suas declarações de cooperação.

- Enviado
- Em revisão (a Microsoft concluirá a revisão em dois dias úteis da declaração enviada. Se o status estiver Em revisão por mais de dois dias, entre em contato com o Suporte.)
- Ação requerida
- Edição
- Aprovado
- Rejeitado

### <a name="claim-payments"></a>Pagamentos de declaração
...
#### <a name="why-are-my-co-op-claim-payments-made-in-two-different-currencies"></a>Por que meus pagamentos de declaração co-op são feitos em duas moedas diferentes
...
#### <a name="why-was-i-paid-in-a-currency-other-than-my-co-op-claim-currency"></a>Por que fui pago em uma moeda diferente da minha moeda de reivindicação de cooperação
...
## <a name="plan-status-and-submission-deadlines"></a>Status do plano e prazos de envio
...
### <a name="plan-submission"></a>Envio de plano
...
### <a name="plan-status"></a>Status do plano
...
### <a name="what-if-my-co-op-claim-is-rejected"></a>E se minha declaração de cooperação for rejeitada

Se for determinado que os materiais fornecidos com sua declaração de cooperação são insuficientes, eles serão rejeitados. Você pode exibir os motivos da rejeição no campo **Histórico** da página de declarações de cooperação. Se você quiser contestar a rejeição, use o procedimento a seguir.
...
3. Selecione a declaração de cooperação que você deseja contestar. Isso abrirá a página de declarações de cooperação.
...
### <a name="poe-status-and-submission-deadlines"></a>Status de PoE e prazos de envio

Você deve enviar a PoE (prova de execução) para seu plano dentro de 180 dias da data de início da campanha. A Microsoft revisará sua PoE no último dia do envio do seguinte mês de POE. Use o procedimento abaixo para enviar a PoE do seu plano.

#### <a name="submit-a-poe"></a>Enviar uma PoE
...
## <a name="determine-program-eligibility"></a>Determinar a qualificação do programa
...
2. Em **Incentivos** na barra de navegação à esquerda, selecione **Visão geral**. Isso abrirá a página **Visão geral do programa**.

3. Selecione o programa desejado para abrir essa página.

4. No campo **Detalhes do programa**, selecione **Guia do programa**.

## <a name="plan-payment"></a>Planejar pagamento
