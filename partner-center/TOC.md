...
## [Localizar o nome de domínio e a ID de diretório do cliente](find-customer-domain-name.md)
...
## [Uso do aplicativo de análise do Partner Center para Microsoft Power BI](power-bi-app-for-direct-partners.md)
