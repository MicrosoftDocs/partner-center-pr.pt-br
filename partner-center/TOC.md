...
### [Programa SATV (Software Assurance Training Voucher) no Partner Center](software-assurance-satv.md)
### [Usar a ferramenta Voucher Validation and Redemption no Partner Center para validar, reservar e resgatar comprovantes](voucher-validation-tool.md)
### [Perguntas frequentes: usando a ferramenta Voucher Validation and Redemption](vvr-faq.md)
...
## [Inscrever-se no programa Provedor de Soluções na Nuvem](enrolling-in-the-csp-program.md)
...
## [Adicionar os Serviços Compartilhados com Parceiros do Azure](shared-services.md)
## [Preços e ofertas](pricing-and-offers.md)
## [Personalize o catálogo](customize-the-catalog.md)

# [Amplie seus negócios](grow-your-business.md)
...
### [Requisitos principais de solicitações de incentivos](core-requirements.md)
...
## [Veja sua lista de clientes](see-your-customer-list.md)
## [Atualize informações da conta do cliente](update-customer-account-info.md)
## [Crie vários usuários para um cliente](adding-multiple-users-to-a-customer-account.md)
## [Atribua contatos de suporte](assign-support-contacts.md)
...
### [Atribua licenças a vários usuários ou revogue-as](bulk-license-provisioning-for-multiple-users.md)
...
### [Aumente a adoção e a satisfação](increasing-adoption-and-satisfaction.md)
...
## [Analisar as assinaturas e as licenças](analyze-subscriptions-licenses.md)
...
# [Obtenha suporte da Microsoft](support-from-microsoft.md)
...
## [Receba notificações de serviço automatizadas com nossas APIs](get-automated-service-notifications-with-our-apis.md)
...
## [Forneça suporte técnico](provide-technical-support.md)
