...
---
# <a name="product-subscriptions-report-available-from-the-partner-center-insights-dashboard"></a>Relatório de Assinaturas de Produto disponível no painel Partner Center Insights produto
...
- Assinaturas ativas:
  - Contagem atual de assinaturas de produtos de nuvem com Uso ativo medido com base na telemetria do produto. Isso exclui todas as assinaturas de avaliação para assinaturas do Azure.
...
:::image type="content" source="images/insights/sub-report-prods-trend.png" alt-text="tendência de produtos.":::
