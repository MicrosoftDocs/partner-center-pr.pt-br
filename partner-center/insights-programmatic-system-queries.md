...
---
# <a name="list-of-system-queries-for-partner-insights-programmatic-access"></a>Lista de consultas do sistema para acesso programático do Partner Insights

As consultas do sistema a seguir podem ser usadas na [API Criar Relatório](insights-programmatic-access-paradigm.md#create-report-api) diretamente com uma QueryId. As consultas do sistema são como os relatórios de exportação Partner Center por um período de computação de seis meses (6 milhões).

Para obter mais detalhes sobre os nomes de coluna, atributos e descrição, consulte as [Definições de dados](insights-data-definitions.md)

As seções a seguir fornecem consultas de relatório para vários relatórios.

## <a name="customers"></a>Clientes

O relatório Clientes dos últimos seis meses

ID da consulta: `6664daf3-c161-423a-92a1-0ea6db2c0384`
...
## <a name="seats-subscriptions-and-revenue"></a>Assinaturas e receita de bancos

Bancos, assinaturas e relatório de receita dos últimos seis meses

ID da consulta: `c9fc1c79-4408-49ff-97f9-e1aa3f155804`
...
ID da consulta: `e65f3a4f-fb99-4319-97ff-59e57566a871`
...
ID da consulta: `d1a4d75e-5ca8-4847-845f-ee0a9be6f07b`
...
Relatório officeUsage dos últimos seis meses

ID da consulta: `d8349f7b-a7d1-467e-b26d-434d4a50f26a`
...
## <a name="dynamics-usage"></a>Uso do Dynamics

Relatório dynamicsUsage por seis meses

ID da consulta: `6209a8fd-93af-442e-8b3f-3df0f77e8463`
...
## <a name="power-bi-usage"></a>Uso do Power BI

Relatório do PowerBIUsage por seis meses

ID da consulta: `40ebfe2f-7183-4427-a911-5c9b45b6df15`
...
## <a name="ems-usage"></a>Uso do EMS

Relatório EMSUsage por seis meses

ID da consulta: `d7f20ea4-8751-4d6b-b1d7-821c316acd6a`
...
Relatório CompetencyPeformanceRequirement por seis meses

ID da consulta: `3a0e1adc-f5c1-42ac-9422-8e944bf81ae5`
...
## <a name="cloud-products-reseller-performance"></a>Desempenho do revendedor de produtos de nuvem

### <a name="report-description"></a>Descrição do relatório

Relatório CloudProductsResellerPerformance por seis meses

ID da consulta: `c09c2eda-861b-4664-8ee8-48a14745a26a`
...
## <a name="clas-agreement-renewal-propensity"></a>Propensão de renovação do contrato CLAS

CLASAgreementRenewalsPropensity report por seis meses

ID da consulta: `c4fc87ac-4cca-44cd-bf4d-835ac513f9ee`
...
## <a name="clas-azure-propensity"></a>Propensão do Azure CLAS

RELATÓRIO CLASAzurePropensity por seis meses

ID da consulta: `9a18bd70-8f90-4bd2-8266-5f6e453e3ee7`
...
## <a name="clas-d365-propensity"></a>Propensão de CLAS D365

CLASD365Programa de densidade por seis meses

ID da consulta: `258fdcac-6e9c-4072-af27-b1b3d97be16c`
...
## <a name="clas-m365-propensity"></a>Propensão do CLAS M365

CLASM365Programa de densidade por seis meses

ID da consulta: `fbe00e32-fdde-4465-b3e4-41bbd021a130`
...
## <a name="teams-usage-3p-apps"></a>Teams Aplicativos 3P de uso

Relatório TeamsUsage3PApps por seis meses

ID da consulta: `42d287be-cc76-4109-a066-f3140ad97fe2`
...
## <a name="teams-usage-workload"></a>Teams de trabalho de uso

TeamsUsageTrabalho de trabalho por seis meses

ID da consulta: `817fe875-acb0-4c45-9201-b7a35a60235a`
...
## <a name="teams-usage-meetings-and-calls"></a>Teams e chamadas de uso

Relatório TeamsUsageMeetingsAndCalls por seis meses

ID da consulta: `b7bd73a8-47e8-4c57-b915-445708cfd7bf`
...
## <a name="competency-summary-history"></a>Histórico de resumo de competência

Relatório CompetencySummaryHistory por seis meses

ID da consulta: `fddab2aa-523d-47f6-90fe-588557306db4`
...
## <a name="training-completion"></a>Conclusão do treinamento

Relatório de conclusão de treinamento por seis meses

ID da consulta: `20f5da57-3c2a-481b-b6a0-ec34d6db14e2`
...
Microsoft Learn relatório dos últimos seis meses

ID da consulta: `0e06c7c3-75ab-4cd5-8178-8cf1a2de49cc`
...
- [Aplicativo de exemplo para acessar dados de análise do Partner Insights](insights-programmatic-sample-application.md)