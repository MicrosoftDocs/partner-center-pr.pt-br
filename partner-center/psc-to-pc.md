...
- Você precisa de um email de trabalho para fazer logon no [Partner Center](https://partner.microsoft.com/).
- Se você estiver usando uma conta que não seja de trabalho no PSC ou em um domínio diferente do que outras pessoas estão usando no PSC, entre em contato com o administrador do PSC para obter ajuda de configuração de conta.
...
Se sua empresa tiver um PDM – quando sua conta do Partner Center estiver configurada e os usuários tiverem migrado e tiverem funções e permissões, você poderá mover suas atividades de vendas para o Partner Center. Informe ao PDM para fazer o comutador, o que permitirá que todas as suas novas negociações fluam para o Partner Center.
>[!Note]
...
## <a name="next-steps-for-psc-admins-psc-deal-managers-and-psc-sellers"></a>Próximas etapas para administradores do PSC, gerentes de negociações do PSC e vendedores do PSC
...
|Soluções|As soluções que pertencem a apenas uma lista de preços podem ser adicionadas a um negócio.|O parceiro pode adicionar [soluções](https://docs.microsoft.com/partner-center/manage-co-sell-opportunities#add-solutions) que pertencem às listas a seguir. a) soluções de suas próprias soluções b) do catálogo de primeira parte da Microsoft (função de negócio: transação no PSC) e c) venda de soluções de outros parceiros de terceiros (função de negócio: ISV no PSC).|
...
### <a name="home-page-of-psc-and-default-view-of-the-co-sell-opportunities-in-partner-center"></a>Home Page do PSC e exibição padrão das oportunidades de venda conjunta no Partner Center
...
### <a name="psc-grid-view-and-the-partner-center-deal-view"></a>Exibição de grade do PSC e visão do negócio do Partner Center
...
### <a name="deal-details-view-in-psc-and-partner-center"></a>Exibição dos detalhes do acordo no PSC e no Partner Center
...
- A data de fechamento da solução estimada só está disponível para as negociações de IOT OEM. Ele não é exibido para nenhum outro tipo de negócio.
...
### <a name="psc-add-products-view-and-the-partner-center-add-solutions-view"></a>Exibição do PSC Adicionar produtos e a exibição do Partner Center Adicionar soluções
...
### <a name="user-management-in-psc-and-partner-center"></a>Gerenciamento de usuários no PSC e no Partner Center
...
### <a name="user-role-assignment-in-psc-and-partner-center"></a>Atribuição de função de usuário no PSC e no centro de parceiros
...
- Todos os gerentes de negócios e os vendedores no PSC devem ser atribuídos à função de administrador de referência.
...
### <a name="notifications-in-psc-and-partner-center"></a>Notificações no PSC e no Partner Center
...
### <a name="q-the-new-deal-button-is-greyed-out-for-our-account-what-should-i-do-to-start-creating-deals"></a>Q. O botão de negociação + novo está esmaecido para nossa conta. O que devo fazer para começar a criar acordos?
...
### <a name="q-can-i-assign-deals-to-a-specific-person-from-our-organization-like-psc"></a>Q. Posso atribuir negociações a uma pessoa específica de nossa organização, como o PSC?
...
### <a name="q-is-there-a-view-of-all-the-deals-assigned-to-me"></a>Q. Há uma exibição de todas as negociações atribuídas a mim?
...
### <a name="q-is-there-a-read-only-view-for-the-deals"></a>Q. Há uma exibição somente leitura para as negociações?
...
### <a name="q-how-can-i-register-a-deal-after-making-it-as-won"></a>Q. Como posso registrar um negócio depois de torná-lo como ganha?
...
### <a name="q-i-get-an-error-message-when-i-click-on-new-deal-registration-button-in-the-deal-registration-section-how-can-i-register-my-deals"></a>Q. Recebo uma mensagem de erro quando clico no botão "+ novo registro de negociações" na seção registro de negociações. Como posso registrar minhas negociações?
...
### <a name="q-is-adding-a-customer-organization-mandatory"></a>Q. Está adicionando uma organização de cliente obrigatória?
...
### <a name="q-are-customer-contact-details-mandatory"></a>Q. Os detalhes de contato do cliente são obrigatórios?
...
### <a name="q-where-can-i-find-the-opportunity-id"></a>Q. Onde posso encontrar a ID da oportunidade?
...
### <a name="q-how-can-my-pdm-get-access-to-pc"></a>Q. Como meu PDM pode obter acesso ao PC?
...
- OCP insights – se PDMs estiver apenas exibindo as negociações & progresso relacionado a elas, eles poderão usar o portal do insights OCP para obter a exibição da sua organização. Essa é uma ferramenta interna e está disponível somente para PDMs e seus usuários.
