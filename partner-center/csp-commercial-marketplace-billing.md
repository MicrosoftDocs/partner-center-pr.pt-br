...
Para obter mais informações sobre o que cada coluna representa, consulte [mapeando cobranças entre uma fatura e o arquivo de reconciliação](use-the-reconciliation-files.md#mapping-charges-between-an-invoice-and-the-reconciliation-file). Consulte também [entendendo os tipos de cobrança no Partner Center](billing-different-types.md#billing-for-one-time-and-select-recurring-charges)
