...
**P: Qual é o processo e o tempo para renovar as competências?**

R: sua empresa pode renovar uma competência no Partner Center. Você precisa atender aos requisitos de desempenho de competência, validar os exames e as habilidades necessários a cada ano e pagar a taxa anual na janela de renovação para manter o status de competência e o acesso aos benefícios associados.

 Antes de renovar sua competência, o administrador global ou admin de conta para sua empresa precisa examinar e atualizar as informações de negócios. Eles podem acessar o perfil da empresa no Partner Center para ver o status e examinar quais informações precisam ser atualizadas. Pode ser necessária documentação adicional para verificar suas informações.  
...
R: as licenças de produto (também conhecidas como licenças de uso interno ou direitos de uso interno) estão incluídas nos benefícios de parceiros que atingem uma competência ou compram um Action Pack da Microsoft. Obtenha uma lista das ofertas atuais de licenças de produto no [Guia de programas de Microsoft Partner Network](https://aka.ms/partner-benefits-use-guide).

**P: um único token pode ser usado para desbloquear várias assinaturas?**

R: não, não é possível dividir tokens para desbloquear várias assinaturas. Os tokens devem ser usados no formato fornecido. Por exemplo, um token de 25 lugares não pode ser dividido em cinco tokens de 5 lugares diferentes.

Para obter informações adicionais, consulte o guia de programas de parceiros da Microsoft [aka.ms/Partner-Benefits-use-Guide](https://aka.ms/partner-benefits-use-guide)

**P:** **se ativamos nosso token para serviços de nuvem em um locatário incorreto ou adicionavam estações em vez de estender, podemos obter um token de substituição?**

R: os tokens de substituição para ativações de serviço de nuvem no locatário incorreto e para estações adicionadas por engano em assinaturas existentes podem ser emitidos apenas uma vez, dentro de 30 dias após a ativação do token original.

Para obter informações adicionais, consulte o guia de programas de parceiros da Microsoft [aka.ms/Partner-Benefits-use-Guide](https://aka.ms/partner-benefits-use-guide)

**P: para licenças de produtos de software local, precisamos ter uma chave do produto (Product Key) para instalação?**

R: nem todos os produtos exigem uma chave do produto (Product Key). A ativação do produto é necessária para os sistemas operacionais Windows Server e cliente e todos os aplicativos cliente do Microsoft Office.
...
**P.:** **Há limitações para como nossa** **empresa pode usar as licenças de produto disponíveis para nós por meio de obtenção de competência ou Action Pack?**

a. Sim, há limitações. Os termos de licença de uso do produto são diferentes para as licenças comerciais adquiridas por meio dos programas de licenciamento da Microsoft. Para obter mais informações, leia [termos de uso de licenciamento do produto](https://www.microsoft.com/licensing).
As licenças de produtos não incluem o Software Assurance e há algumas restrições em licenças de produtos. Você pode examinar os termos de uso das licenças de produto no [Guia de programas do Microsoft Partner Network](https://aka.ms/partner-benefits-use-guide).

**P.:** **Como adicionar mais licenças de produto ao que está listado no Partner Center para que nossa** **empresa seja coberta?**

a. As licenças de produto incluídas com a obtenção de competência e os Action Pack têm diferentes termos de uso de licenças comerciais adquiridas por meio de programas de licenciamento da Microsoft. É recomendável revisar suas opções para atender às necessidades de licenciamento da sua empresa no [Licenciamento da Microsoft](https://www.microsoft.com/licensing).
...
## <a name="competency-extension-to-offset-effects-of-covid-19"></a>Extensão de competência para efeitos de deslocamento de COVID-19

**P: a Microsoft oferece ajuda para parceiros voltados para o dificuldade?**

R: para parceiros com data de vencimento de competência entre 1º de julho e 31 de dezembro de 2020, estamos estendendo a competência ou as competências existentes do parceiro por meio de sua próxima data de aniversário em 2021. O parceiro receberá um lembrete de renovação para refletir essa nova oferta. O parceiro precisa pagar sua taxa de competência no período de renovação de 30 dias.

**P: e se um parceiro perder seu período de renovação de 30 dias?**

R: o parceiro pode reativar sua competência e obter acesso a recursos e benefícios, pagando sua taxa na página de ofertas de associação no Partner Center até 30 dias após sua data de aniversário. Se um parceiro perder o período de carência de 30 dias, poste sua data de aniversário, ele deverá enviar um tíquete de suporte por meio do Partner Center, informando os detalhes de sua solicitação para receber uma substituição COVID depois que o período de renovação de 30 dias tiver expirado.

Para obter informações adicionais, leia [renovar oferta do MPN](renew-mpn-offers.md).
