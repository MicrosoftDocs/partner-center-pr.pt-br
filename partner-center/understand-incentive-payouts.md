...
Essa opção fornece um download dos pagamentos recebidos em seu banco para um determinado programa, o imposto associado e a quantidade de conquista agregada.
...
|quantity |Esse campo varia de acordo com o programa. Para programas transacionais, ele indica a quantidade cobrada. |
|ganhandotype   |Indica se é uma taxa, um desconto, um Coop, uma venda etc.   |
...
|productName   |Nome da família de produtos linhado para transação   |
