...
|**Campo**  |**Descrição**    |
|------------------|:-------------------------------------|
|Total pago neste ano        |O total combinado pagou a você neste ano, em dólares americanos, para todas as suas IDs da MPN.                                      |
...
|Último pagamento           |O valor (em dólares americanos), o nome do programa e a ID do MPN do pagamento mais recente.                                      |
|Pagamentos por origem       |Quantidade de pagamentos em dólares americanos, representado pelo programa nos últimos 12 meses.                                      |
|Pagamentos                       |Selecione **Paid** ou **pendente** e, em seguida, classificar como desejar. Para obter detalhes adicionais de um pagamento específico, selecione **exibição**. Para baixar uma cópia da instrução de remessa de pagamento, selecione **baixar**. Observe que os dados de histórico de transação podem levar até 24 horas para serem exibidas, portanto, você não poderá ver os ganhos associados imediatamente.  |
...
|Rejeitada durante a revisão        |O pagamento foi rejeitado durante a revisão.          |Entre em contato com o suporte da Microsoft para obter detalhes         |
|Failed (Falha)        |O pagamento falhou devido a um erro de sistema do Microsoft.         |Entre em contato com o suporte da Microsoft para obter detalhes         |
...
|Nota fiscal de impostos rejeitada       |Sua fatura de imposto foi rejeitada durante a revisão. Todos os pagamentos pendentes serão em espera até que a revisão de nota fiscal de imposto seja concluída.          |Entre em contato com o suporte da Microsoft para obter detalhes         |
...
Essa opção fornece um download dos pagamentos recebidas em seu banco para determinado programa, o imposto associado e agregados quantidade ganhando.

|**Nome da coluna**   |**Descrição**   |
|------------------|:-------------------------------------|
|participantID   |A identidade primária do parceiro ganhar sob o programa      |
|participantIDType   |Normalmente, MPN para programas de incentivo e ID do vendedor para programas de Store      |
...
Essa opção fornece um download de cada item de linha de rendimentos que você vê na página de histórico de transação, a obtenção de tipo, data, o valor da transação associada, cliente, produto e outros detalhes transacionais aplicáveis para o programa de incentivos.
...
|transactionDate   |Data da transação. É útil para programas onde muitas transações contribuem para a obtenção de um.   |
...
|Quantidade |Este campo varia de acordo com o programa. Para programas transacionais, ele indica quantidade cobrada. |
|earningType   |Indica se é uma taxa, descontos, coop, origem de venda, etc.   |
...
|customerName   |Nome de transação do cliente   |


Além da tabela acima, esses campos de histórico de transações serão disponibilizado como aplicável para o programa.

|**Nome da coluna**   |**Descrição**   |
|------------------|:-------------------------------------|
|partNumber   |Número de peça vinculado à transação. Terminologia da Microsoft.   |
|productName   |Nome da família de produto embutido em transações   |
