...
Você pode saber mais sobre os programas de licenciamento específicos dos recursos a seguir.
...
|Examine os detalhes sobre os direitos de uso interno do MPN ou os benefícios.  | [Guia de programas do Microsoft Partner Network](https://assets.microsoft.com/MPN-MAPS-Product-Usage-Guide.pdf)  |
|Encontre materiais de parceiros OEM como kits de pré-instalação ou treinamento.  | [Centro de parceiros de dispositivos da Microsoft](https://devicepartner.microsoft.com/)  |
|Responda a perguntas de uso para clientes OEM ou clientes de varejo (também conhecidos como produtos completos de produto ou FPP clientes). Isso é para clientes cujo software foi licenciado para eles pela Microsoft ou por um fabricante de computadores. *(Esses termos não se aplicam aos clientes no programa de licenciamento por volume.)*  | [Termos de uso de varejo (FPP)](https://www.microsoft.com/useterms)  |

## <a name="resources-associated-with-license-fulfillment-or-financing-options"></a>Recursos associados às opções de cumprimento de licença ou de financiamento
...
Como um parceiro da Microsoft, você pode pedir ajuda de outros parceiros envolvidos em seu sucesso. Você também pode solicitar ajuda de Suporte da Microsoft. Os especialistas de suporte estão disponíveis para ajudá-lo com problemas de programas de parceiros, assistência pré-vendas, problemas com produtos da Microsoft, perguntas de cobrança e muito mais.

Vá para [suporte ao parceiro da Microsoft](https://partner.microsoft.com/support/?stage=1) para exibir suas opções de suporte ou para iniciar um tíquete de suporte.
