...
As especializações avançadas que não exigem uma auditoria ou referência de cliente incluem:
...
## <a name="how-azure-consumption-revenue-acr-is-calculated-for-each-advanced-specialization"></a>Como a receita de consumo do Azure (ACR) é calculada para cada Especialização avançada:

- Associações de parceiro para cliente incluídas: [parceiro digital de associação de registro](https://support.microsoft.com/topic/link-a-partner-id-for-azure-performance-pal-or-dpor-a8eed43b-82a8-f017-3b1a-f9c8aa385d32) a um cliente ou parceiro direto de cobrança do CSP ou revendedor indireto do CSP para uma associação de cliente ou [link de administrador de parceiro (PAL)](/azure/cost-management-billing/manage/link-partner-id) a um cliente.
- ACR de assinaturas com tipos de oferta avaliação, programas de benefícios, suporte e interno não é contado em direção à especialização avançada.

**Campos de receita de consumo do Azure**

| Nome do campo | Descrição do campo |
|-------------|----------------------|
| Nível de serviço 1 | Nível mais alto no qual os serviços do Azure são agrupados (consulte: https://azure.microsoft.com/services/) . |
| Nível de serviço 2 | Segundo os serviços do Azure de nível mais alto com base (por exemplo: https://azure.microsoft.com/pricing/) |
| Nível de serviço 3 | Com base nos serviços do Azure de nível mais alto (por exemplo: https://azure.microsoft.com/pricing/details/virtual-machines/linux/) |
| Nível de serviço 4 | O quarto nível mais alto de serviços do Azure com base (por exemplo: https://azure.microsoft.com/pricing/details/virtual-machines/linux/) |
| Grupo de serviços 2 | Agrupamento de serviços do Azure de acordo com uma categoria de serviço |
| Grupo de serviços 3 | Agrupamento de serviços do Azure de acordo com uma subcategoria de serviço |
| Influenciador de serviço | Agrupamento de serviços do Azure mapeados para uma atividade de consumo específica |
| Sistema operacional de computação | Sistema operacional de computação |
