...
1.  Entre no Partner Center com sua conta corporativa e selecione **MPN** no menu à esquerda.
...
1.  No Partner Center, selecione **configurações de conta**.
    -   Para localizar sua ID da Microsoft, selecione **perfil da organização**.
...
3.  Preencha o formulário. Para o **tipo de problema**, selecione **não pode gerenciar meu perfil**. Na descrição, inclua sua ID do MPN e a ID da Microsoft.
...
1.  No Partner Center, selecione **ofertas de associação**e, em seguida, selecione **disponível**. 
