...
A tabela tem o total de clientes potenciais, os clientes potenciais que foram aceitos no SLA (24 horas) em termos de porcentagem e absoluta, os clientes potenciais expirados e os clientes potenciais que entraram em estado ganho junto com o valor de leads total ganho na moeda USD. Também há um gráfico de tendência de clientes potenciais à direita da tabela que mostra o total de acordos e o valor de negócio ganho na moeda USD com base no programa selecionado. A seleção padrão será Todas as soluções.
...
Esta seção ajudará você a analisar os motivos pelos quais os leads estão sendo marcados como **recusados** ou **perdidos** por sua empresa. As opções nessas representações são as mesmas razões que seus vendedores escolheram ao fechar o cliente potencial como recusado ou perdido.
...
Quando tipo de qualificação é selecionado, você tem a opção de comparar o desempenho das indicações com relação aos leads do Marketplace e aos Leads qualificados. Para os mercados e o programa de referência, você pode escolher até três opções diferentes para comparar seu desempenho. O primeiro grafo, que é um gráfico de barras, terá dados apresentados com uma tendência mês a mês baseada na tabela dinâmica principal, que representa o volume ou o valor de acordos conquistados. Também há um gráfico de pizza à direita do gráfico de barras, que mostrará a distribuição por percentual para obter os mesmos dados.
...
A tabela abaixo, com todos os dados brutos relacionados aos clientes potenciais, ajudará você a **Exportar** rapidamente os dados para qualquer análise detalhada ou personalizada que você deseja executar.
...
Pode haver várias razões pelas quais você está obtendo um gráfico em branco, como abaixo, ao acessar a análise de leads, conforme descrito abaixo.
...
- Há um atraso entre a alteração do estado do cliente potencial e o mesmo a ser atualizado no relatório de análise. Verifique o relatório após 24 horas.
