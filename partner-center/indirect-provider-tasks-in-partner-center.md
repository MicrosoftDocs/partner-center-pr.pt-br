...
Revendedores novos estão entrando no mercado e buscando maneiras de oferecer suas soluções para clientes fora de seus mercados e localidades. Como um provedor de tecnologia estabelecido, você está bem posicionado para ser a sua rota para o mercado. faça parceria com revendedores indiretos no programa Provedor de Soluções na Nuvem (CSP) para se conectar a outros parceiros, trazer novas soluções para o mercado e aprimorar a adoção dos serviços de nuvem pelos clientes.
...
4. Depois que o revendedor aceitar sua solicitação de parceria, ela aparecerá em sua lista de revendedores indiretos e você poderá:
   ...
   - Designá-los como o contato de suporte do cliente para assinaturas específicas
...
Quando os clientes quiserem comprar novas assinaturas, atualizar as existentes ou comprar licenças adicionais, você fará essas alterações na conta do cliente por meio do portal Microsoft 365. Você não pode fazer isso no portal do Azure.

1. Selecione **Clientes** no menu **Partner Center** configuração.
...
5. As novas assinaturas aparecem na lista de assinaturas do cliente.
...
- [Como os provedores indiretos podem ajudar seus revendedores a adotar o Contrato de Parceiro da Microsoft – Perguntas Frequentes](mpa-indirect-provider-faq.yml)
