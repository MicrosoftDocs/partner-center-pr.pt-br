...
- Você pode cancelar a assinatura como qualquer outra assinatura. Acesse o menu **Painel** > **Configurações de conta** > **Serviços compartilhados**. Selecione a assinatura do Azure - Serviços Compartilhados/Internos e cancele-a.
...
Para ver o novo arquivo de definição de preços dos Serviços Compartilhados do Parceiro Azure, acesse **Serviços baseados em uso > Preços e ofertas** e selecione a lista de preços do mês atual. Nas próximas semanas, também será lançada uma API de tabela de tarifas específica.
