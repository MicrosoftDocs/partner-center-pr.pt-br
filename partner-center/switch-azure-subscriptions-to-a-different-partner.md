...
---
# <a name="switch-azure-subscriptions-to-a-different-partner"></a>Transferir assinaturas do Azure para outro parceiro
...
2.  O parceiro CSP da assinatura deve executar as seguintes tarefas:
