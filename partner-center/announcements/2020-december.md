...
### <a name="categories"></a><span data-ttu-id="c6b9d-107">Categorias</span><span class="sxs-lookup"><span data-stu-id="c6b9d-107">Categories</span></span>
...
### <a name="categories"></a><span data-ttu-id="c6b9d-130">Categorias</span><span class="sxs-lookup"><span data-stu-id="c6b9d-130">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="c6b9d-145">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="c6b9d-145">Next steps</span></span>
...
### <a name="details"></a><span data-ttu-id="c6b9d-157">Detalhes</span><span class="sxs-lookup"><span data-stu-id="c6b9d-157">Details</span></span>
...
- <span data-ttu-id="c6b9d-175">Listas de preços de reservas do plano do Azure</span><span class="sxs-lookup"><span data-stu-id="c6b9d-175">Azure plan reservations price lists</span></span>
...
### <a name="questions"></a><span data-ttu-id="c6b9d-200">Perguntas</span><span class="sxs-lookup"><span data-stu-id="c6b9d-200">Questions</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="c6b9d-210">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="c6b9d-210">Next steps</span></span>
...
### <a name="details"></a><span data-ttu-id="c6b9d-221">Detalhes</span><span class="sxs-lookup"><span data-stu-id="c6b9d-221">Details</span></span>
...
- <span data-ttu-id="c6b9d-260">Se estiver usando uma solução de CPV (fornecedor de painel de controle), consulte seu CPV.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-260">If you’re using a control panel vendor (CPV) solution, consult your CPV.</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="c6b9d-272">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="c6b9d-272">Impacted audience</span></span>
...
### <a name="perpetual-software-in-csp"></a><span data-ttu-id="c6b9d-284">Software perpétuo no CSP</span><span class="sxs-lookup"><span data-stu-id="c6b9d-284">Perpetual software in CSP</span></span>
...
### <a name="details"></a><span data-ttu-id="c6b9d-305">Detalhes</span><span class="sxs-lookup"><span data-stu-id="c6b9d-305">Details</span></span>
...
<span data-ttu-id="c6b9d-317">Todos os parceiros que fazem transações pelo programa CSP (Provedor de Soluções na Nuvem)</span><span class="sxs-lookup"><span data-stu-id="c6b9d-317">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>
...
<span data-ttu-id="c6b9d-361">**SelfServePolicies – nova funcionalidade adicionada**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-361">**SelfServePolicies - new functionality added**</span></span>
...
### <a name="categories"></a><span data-ttu-id="c6b9d-375">Categorias</span><span class="sxs-lookup"><span data-stu-id="c6b9d-375">Categories</span></span>
...
<span data-ttu-id="c6b9d-386">As listas de preços baseada em licença de dezembro contêm as ofertas abaixo que não devem estar nas listas de preços.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-386">The December license-based price lists contain the below offers that should not be in the price lists.</span></span> <span data-ttu-id="c6b9d-387">Essas ofertas foram incluídas anteriormente nas listas de preços por engano e não deveriam ter sido publicadas.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-387">These offers were previously included in the price lists in error and should not have been published.</span></span> <span data-ttu-id="c6b9d-388">Não há nenhum cronograma de disponibilidade dessas ofertas.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-388">There is no schedule as to when these offers may be available.</span></span> <span data-ttu-id="c6b9d-389">No futuro, se elas forem adicionadas de volta, serão listadas como ACRÉSCIMOS em listas de preços de visualização futura.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-389">In the future, if they are added back they will be listed as ADDs in future preview price lists.</span></span>
   ...
   |<span data-ttu-id="c6b9d-390">**Nome da oferta**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-390">**Offer name**</span></span>|<span data-ttu-id="c6b9d-391">**ID da oferta**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-391">**Offer ID**</span></span>|
   |-------------------|:------|
...
<span data-ttu-id="c6b9d-405">As ofertas a seguir estavam na matriz da lista de ofertas com erro.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-405">Below offers were in the offer list matrix in error.</span></span> <span data-ttu-id="c6b9d-406">Elas não estão disponíveis. Ainda não há uma data de destino para a disponibilidade.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-406">They are not available, there is not target date yet for availability.</span></span> <span data-ttu-id="c6b9d-407">Os parceiros devem ignorar esses itens de linha.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-407">Partners should ignore these line items.</span></span>
   ...
   |-------------------|:------|
   |<span data-ttu-id="c6b9d-410">Dynamics 365 Operations – Capacidade do banco de dados (preços sem fins lucrativos)</span><span class="sxs-lookup"><span data-stu-id="c6b9d-410">Dynamics 365 Operations - Database Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="c6b9d-411">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span><span class="sxs-lookup"><span data-stu-id="c6b9d-411">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span></span>|
   |<span data-ttu-id="c6b9d-412">Dynamics 365 Operations – Capacidade do arquivo (preços sem fins lucrativos)</span><span class="sxs-lookup"><span data-stu-id="c6b9d-412">Dynamics 365 Operations - File Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="c6b9d-413">dc173a86-285b-444c-881e-3ece531f67da</span><span class="sxs-lookup"><span data-stu-id="c6b9d-413">dc173a86-285b-444c-881e-3ece531f67da</span></span>|

#### <a name="powerapps-offer"></a><span data-ttu-id="c6b9d-414">Oferta do PowerApps</span><span class="sxs-lookup"><span data-stu-id="c6b9d-414">Powerapps offer</span></span>

<span data-ttu-id="c6b9d-415">Essa oferta foi incluída na matriz da lista de ofertas, mas não na lista de preços de dezembro.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-415">This offer was included in the offer list matrix but not the December price list.</span></span> <span data-ttu-id="c6b9d-416">A oferta está disponível, e os preços podem ser encontrados no arquivo de novembro da lista de preços do mês anterior.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-416">The offer is available and pricing can be found in the previous month's price list November file.</span></span> <span data-ttu-id="c6b9d-417">Esta oferta deve ser adicionada novamente à lista de preços de janeiro.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-417">This offer should be added back to the January price list.</span></span>

   |<span data-ttu-id="c6b9d-418">**Nome da oferta**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-418">**Offer name**</span></span>|<span data-ttu-id="c6b9d-419">**ID da oferta**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-419">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="c6b9d-420">Plano do Power Apps por aplicativo</span><span class="sxs-lookup"><span data-stu-id="c6b9d-420">Power Apps per app plan</span></span>|<span data-ttu-id="c6b9d-421">5e1087b6-246b-4503-b88a-b60bdf0b3840</span><span class="sxs-lookup"><span data-stu-id="c6b9d-421">5e1087b6-246b-4503-b88a-b60bdf0b3840</span></span>|

### <a name="next-steps"></a><span data-ttu-id="c6b9d-422">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="c6b9d-422">Next steps</span></span>

<span data-ttu-id="c6b9d-423">Verifique as notas sobre a versão com frequência porque, caso outros problemas sejam descobertos, eles serão acrescentados a este comunicado.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-423">Check release notes often as other issues are uncovered they will be appended to this announcement.</span></span>

### <a name="last-updated"></a><span data-ttu-id="c6b9d-424">Última atualização</span><span class="sxs-lookup"><span data-stu-id="c6b9d-424">Last updated</span></span>

<span data-ttu-id="c6b9d-425">8 de dezembro de 2020</span><span class="sxs-lookup"><span data-stu-id="c6b9d-425">December 8, 2020</span></span>

______________

## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a><span data-ttu-id="c6b9d-426">Uma atualização do US Microsoft 365 Business Voice com oferta de Plano de Chamada estará disponível em breve</span><span class="sxs-lookup"><span data-stu-id="c6b9d-426">An update of the US Microsoft 365 Business Voice with Calling Plan offer is coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="c6b9d-427">Categorias</span><span class="sxs-lookup"><span data-stu-id="c6b9d-427">Categories</span></span>

- <span data-ttu-id="c6b9d-428">Data: 2020-12-3</span><span class="sxs-lookup"><span data-stu-id="c6b9d-428">Date: 2020-12-3</span></span>
- <span data-ttu-id="c6b9d-429">Ofertas/mercados</span><span class="sxs-lookup"><span data-stu-id="c6b9d-429">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="c6b9d-430">Resumo</span><span class="sxs-lookup"><span data-stu-id="c6b9d-430">Summary</span></span> 

<span data-ttu-id="c6b9d-431">Em 1º de janeiro de 2021, a Microsoft começará a fazer a transição de parceiros e clientes dos EUA para uma nova oferta do Microsoft 365 Business Voice com Plano de Chamada.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-431">On January 1, 2021, Microsoft will begin transitioning US partners and customers to a new Microsoft 365 Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="c6b9d-432">Nenhuma ação do parceiro é necessária.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-432">No partner action is required.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="c6b9d-433">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="c6b9d-433">Impacted Audience</span></span> 

<span data-ttu-id="c6b9d-434">Todos os parceiros que fazem transações pelo programa CSP (Provedor de Soluções na Nuvem)</span><span class="sxs-lookup"><span data-stu-id="c6b9d-434">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="c6b9d-435">Detalhes</span><span class="sxs-lookup"><span data-stu-id="c6b9d-435">Details</span></span>

<span data-ttu-id="c6b9d-436">A Microsoft substituirá a oferta existente do Business Voice com Plano de Chamada nos EUA por uma nova oferta para dar suporte a requisitos internos para produtos de telecomunicações.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-436">Microsoft will replace the existing Business Voice with Calling plan offer in the US with a new offer to support internal requirements for telco products.</span></span> <span data-ttu-id="c6b9d-437">A nova oferta terá o mesmo conjunto de recursos e preços.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-437">The new offer will have the same feature set and pricing.</span></span> <span data-ttu-id="c6b9d-438">As alterações da oferta são internas à Microsoft e não devem afetar a forma como os parceiros de CSP comercializam, vendem ou dão suporte à oferta do Business Voice com Plano de Chamada.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-438">The offer changes are internal to Microsoft and should not affect the way that CSP partners market, sell, or support the Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="c6b9d-439">A alteração será aplicada somente a esta oferta.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-439">The change will only apply to this offer.</span></span>

<span data-ttu-id="c6b9d-440">Para novas vendas, você usará a nova oferta a partir de 1º de janeiro de 2021.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-440">For new sales, you will use the new offer starting on January 1, 2021.</span></span> <span data-ttu-id="c6b9d-441">A oferta antiga será substituída pela nova oferta na lista de preços.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-441">The old offer will be replaced by the new offer on the price list.</span></span>

<span data-ttu-id="c6b9d-442">Os clientes existentes serão automaticamente transferidos para a nova oferta após sua data de renovação.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-442">Existing customers will be automatically transitioned to the new offer upon their renewal date.</span></span> <span data-ttu-id="c6b9d-443">Nenhuma ação é necessária dos parceiros e dos clientes de renovação.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-443">No action is required from partners and renewing customers.</span></span>


<span data-ttu-id="c6b9d-444">\*\*Detalhes da nova oferta</span><span class="sxs-lookup"><span data-stu-id="c6b9d-444">\*\*New offer details</span></span>
 
   |<span data-ttu-id="c6b9d-445">**Nome da oferta**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-445">**Offer name**</span></span>|<span data-ttu-id="c6b9d-446">**ID da oferta**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-446">**Offer ID**</span></span>|<span data-ttu-id="c6b9d-447">**ID do material**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-447">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="c6b9d-448">Microsoft 365 Business Voice (EUA)</span><span class="sxs-lookup"><span data-stu-id="c6b9d-448">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="c6b9d-449">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span><span class="sxs-lookup"><span data-stu-id="c6b9d-449">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span></span>|<span data-ttu-id="c6b9d-450">PZW-00023</span><span class="sxs-lookup"><span data-stu-id="c6b9d-450">PZW-00023</span></span>|
   
<span data-ttu-id="c6b9d-451">\*\*Detalhes da oferta antiga</span><span class="sxs-lookup"><span data-stu-id="c6b9d-451">\*\*Old offer details</span></span>

   |<span data-ttu-id="c6b9d-452">**Nome da oferta**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-452">**Offer name**</span></span>|<span data-ttu-id="c6b9d-453">**ID da oferta**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-453">**Offer ID**</span></span>|<span data-ttu-id="c6b9d-454">**ID do material**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-454">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="c6b9d-455">Microsoft 365 Business Voice (EUA)</span><span class="sxs-lookup"><span data-stu-id="c6b9d-455">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="c6b9d-456">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="c6b9d-456">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>|<span data-ttu-id="c6b9d-457">PZW-00009</span><span class="sxs-lookup"><span data-stu-id="c6b9d-457">PZW-00009</span></span>|

### <a name="next-steps"></a><span data-ttu-id="c6b9d-458">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="c6b9d-458">Next steps</span></span>

<span data-ttu-id="c6b9d-459">Familiarize-se com a lista de preços e compartilhe estas informações com todos os contatos apropriados em sua organização.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-459">Familiarize yourself with the price list and share this information with all appropriate contacts in your organization.</span></span>

______________

## <a name="now-live-partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="1"></a><span data-ttu-id="c6b9d-460">Ao vivo agora: atualizações de API do Partner Center e aprimoramentos da interface do usuário para obter o processo de validação do cliente de Educação</span><span class="sxs-lookup"><span data-stu-id="c6b9d-460">Now live: Partner Center API updates and user interface enhancements for the Education customer validation process</span></span>

### <a name="categories"></a><span data-ttu-id="c6b9d-461">Categorias</span><span class="sxs-lookup"><span data-stu-id="c6b9d-461">Categories</span></span>

- <span data-ttu-id="c6b9d-462">Data: 2020-12-3</span><span class="sxs-lookup"><span data-stu-id="c6b9d-462">Date: 2020-12-3</span></span>
- <span data-ttu-id="c6b9d-463">Funcionalidades</span><span class="sxs-lookup"><span data-stu-id="c6b9d-463">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="c6b9d-464">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="c6b9d-464">Impacted Audience</span></span> 

<span data-ttu-id="c6b9d-465">Os parceiros que vendem ofertas Acadêmicas por meio do programa Provedor de Soluções na Nuvem</span><span class="sxs-lookup"><span data-stu-id="c6b9d-465">Partners selling Academic offers through the Cloud Solution Provider program</span></span>

### <a name="summary"></a><span data-ttu-id="c6b9d-466">Resumo</span><span class="sxs-lookup"><span data-stu-id="c6b9d-466">Summary</span></span> 

<span data-ttu-id="c6b9d-467">O trabalho da Microsoft é baseado em confiança.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-467">Microsoft runs on trust.</span></span> <span data-ttu-id="c6b9d-468">Temos o compromisso de fornecer um método em conformidade e seguro de validação de clientes para realizar transações de ofertas Acadêmicas no programa Provedor de Soluções na Nuvem.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-468">We are committed to providing a compliant, safe, and secure method of customer validation for transacting Academic offers in the Cloud Solution Provider program.</span></span> <span data-ttu-id="c6b9d-469">Como parte desse compromisso, estamos introduzindo a API do Partner Center e aprimoramentos na interface do usuário, que adicionarão clareza e visibilidade ao processo de habilitação do cliente, bem como a capacidade de inserir dados mais precisos para aumentar o sucesso na habilitação do cliente.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-469">As part of this commitment, we are introducing Partner Center API and user interface enhancements that will add clarity and visibility into the customer vetting process as well as the ability to input more accurate data, which will drive improved customer vetting success.</span></span> 

<span data-ttu-id="c6b9d-470">**Aprimoramentos do Partner Center**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-470">**Partner Center enhancements**</span></span> 

- <span data-ttu-id="c6b9d-471">Novas APIs de Qualificações GET e POST para dar suporte à entrada de dados precisos e aprimorar o processo de validação do cliente de Educação da Microsoft.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-471">New GET and POST Qualifications APIs to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

- <span data-ttu-id="c6b9d-472">Aprimoramentos na interface do usuário para dar suporte à entrada de dados precisos e aprimorar o processo de validação do cliente de Educação realizado pela Microsoft.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-472">User interface enhancements to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

<span data-ttu-id="c6b9d-473">**Substituição das APIs de qualificação GET e PUT existentes**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-473">**Deprecation of existing GET and PUT Qualification APIs**</span></span> 

<span data-ttu-id="c6b9d-474">As APIs de qualificação GET e PUT existentes serão desativadas **antes do fim de fevereiro de 2021**.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-474">The existing GET and PUT Qualification APIs will retire **before the end of February 2021**.</span></span> <span data-ttu-id="c6b9d-475">Nesse momento, você precisará fazer a transição para as novas APIs GET e POST do Partner Center para poder comprar ofertas para Educação.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-475">At that time, you will need to have transitioned to the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span>  

<span data-ttu-id="c6b9d-476">Testes.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-476">**Testing**</span></span> 

<span data-ttu-id="c6b9d-477">Para entender melhor as APIs e a entrada de dados necessárias para obter êxito na validação do cliente, os parceiros podem testar esses aprimoramentos.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-477">To gain a better understanding of the APIs and data entry required for successful customer validation, partners can test these enhancements.</span></span> <span data-ttu-id="c6b9d-478">Os parceiros que desejam participar do teste deverão baixar o [guia de testes do cliente de Educação do Partner Center](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) para obter instruções sobre como se preparar, como se inscrever e o que esperar durante a fase de testes.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-478">Partners who want to participate in the testing should download the [Partner Center Education customer testing guide](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) for directions on how to prepare, sign up, and for information on what to expect during the testing phase.</span></span>

<span data-ttu-id="c6b9d-479">**Clientes de biblioteca e museu**</span><span class="sxs-lookup"><span data-stu-id="c6b9d-479">**Library and Museum customers**</span></span> 

<span data-ttu-id="c6b9d-480">Além dos aprimoramentos acima, estamos empolgados em anunciar que habilitaremos ofertas com preços Acadêmicos para clientes de biblioteca e museu, expandindo os clientes de Educação com os quais você pode realizar transações de ofertas CSP.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-480">In addition to the above enhancements, we are excited to announce that we will enable Academic-priced offers for Library and Museum customers, expanding the Education customers with whom you can transact CSP offers.</span></span> 

<span data-ttu-id="c6b9d-481">A Microsoft reserva a si o direito de examinar o status de qualquer cliente ou cliente proposto como um usuário de Educação qualificado.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-481">Microsoft reserves the right to review the status of any customer or proposed customer as a qualified educational user.</span></span> <span data-ttu-id="c6b9d-482">Para obter detalhes completos, confira os [Requisitos de Usuário para obter uma Educação Acadêmica Qualificada](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span><span class="sxs-lookup"><span data-stu-id="c6b9d-482">See the [Academic Qualified Education User Requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) for full details.</span></span> 

### <a name="next-stepsadditional-resources"></a><span data-ttu-id="c6b9d-483">Próximas etapas/recursos adicionais</span><span class="sxs-lookup"><span data-stu-id="c6b9d-483">Next steps/additional resources</span></span>

- <span data-ttu-id="c6b9d-484">Examine a nova Interface do Usuário do Partner Center, as alterações de API e o guia nos recursos de preparação de operações:  Aprimoramentos do processo de [validação do cliente de Educação do Partner Center](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span><span class="sxs-lookup"><span data-stu-id="c6b9d-484">Review the new Partner Center User Interface, API changes, and Guide in the Operations Readiness resources:  [Partner Center Education customer validation](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/) process enhancements</span></span> 

- <span data-ttu-id="c6b9d-485">Verifique se a sua organização está familiarizada com os [requisitos do Usuário de Educação Acadêmica Qualificada](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span><span class="sxs-lookup"><span data-stu-id="c6b9d-485">Ensure your organization is familiar with the [Academic Qualified Education User requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span></span> 

- <span data-ttu-id="c6b9d-486">Compartilhe essas informações com as equipes apropriadas da sua organização e com seus revendedores para ajudá-los a se preparar para essas alterações.</span><span class="sxs-lookup"><span data-stu-id="c6b9d-486">Share this information with the appropriate teams within your organization, and with your resellers, to help them prepare for these changes.</span></span> 

### <a name="change-log"></a><span data-ttu-id="c6b9d-487">Log de Alterações</span><span class="sxs-lookup"><span data-stu-id="c6b9d-487">Change Log</span></span> 

<span data-ttu-id="c6b9d-488">_ 31 de agosto de 2020:  Publicação original</span><span class="sxs-lookup"><span data-stu-id="c6b9d-488">_ August 31, 2020:  Original publication</span></span> 

- <span data-ttu-id="c6b9d-489">25 de setembro de 2020:  Atualização de janela de teste adicionada</span><span class="sxs-lookup"><span data-stu-id="c6b9d-489">September 25, 2020:  Test window update added</span></span> 

- <span data-ttu-id="c6b9d-490">4 de outubro de 2020: Lembrete para inscrever-se para teste</span><span class="sxs-lookup"><span data-stu-id="c6b9d-490">October 4, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="c6b9d-491">10 de novembro de 2020: Lembrete para inscrever-se para teste</span><span class="sxs-lookup"><span data-stu-id="c6b9d-491">November 10, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="c6b9d-492">3 de dezembro de 2020: Atualizações de API ao vivo</span><span class="sxs-lookup"><span data-stu-id="c6b9d-492">December 3, 2020: API updates live</span></span>