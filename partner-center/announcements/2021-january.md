...
### <a name="categories"></a><span data-ttu-id="b3c5b-108">Categorias</span><span class="sxs-lookup"><span data-stu-id="b3c5b-108">Categories</span></span>
...
<span data-ttu-id="b3c5b-132">Essa atualização reduzirá a complexidade e a sobrecarga com o faturamento em várias moedas na região da EU/EFTA e do Reino Unido para a nova experiência de comércio.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-132">This update will reduce the complexity and overhead with multi-currency invoicing in the EU/EFTA & UK for the new commerce experience.</span></span>
...
- <span data-ttu-id="b3c5b-178">Armênia</span><span class="sxs-lookup"><span data-stu-id="b3c5b-178">Armenia</span></span>
...
### <a name="questions"></a><span data-ttu-id="b3c5b-196">Perguntas?</span><span class="sxs-lookup"><span data-stu-id="b3c5b-196">Questions?</span></span>
...
- <span data-ttu-id="b3c5b-209">Data: 27/01/2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-209">Date: 2021-01-27</span></span>
...
#### <a name="the-new-commerce-experience-for-azure-in-csp"></a><span data-ttu-id="b3c5b-245">A nova experiência de comércio para o Azure no CSP</span><span class="sxs-lookup"><span data-stu-id="b3c5b-245">The new commerce experience for Azure in CSP</span></span>
...
<span data-ttu-id="b3c5b-280">**Fase 3 – data a ser determinada**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-280">**Phase 3 – Date TBD**</span></span>
...
#### <a name="the-new-commerce-experience"></a><span data-ttu-id="b3c5b-294">A nova experiência de comércio</span><span class="sxs-lookup"><span data-stu-id="b3c5b-294">The new commerce experience</span></span>
...
<span data-ttu-id="b3c5b-319">Em caso de dúvidas adicionais, confira as comunidades relevantes sobre o CSP no Yammer.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-319">For any further questions please check your relevant CSP Yammer communities.</span></span>
...
### <a name="details"></a><span data-ttu-id="b3c5b-331">Detalhes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-331">Details</span></span>
...
|<span data-ttu-id="b3c5b-354">{baseURL}/v1/customers/{ID_do_cliente}/subscriptions/{ID_da_assinatura}/addons</span><span class="sxs-lookup"><span data-stu-id="b3c5b-354">{baseURL}/v1/customers/{customer_id}/subscriptions/{subscription_id}/addons</span></span>  | [<span data-ttu-id="b3c5b-355">Obter uma lista de complementos de uma assinatura</span><span class="sxs-lookup"><span data-stu-id="b3c5b-355">Get a list of add-ons for a subscription</span></span>](/partner-center/develop/get-a-list-of-add-ons-for-a-subscription) |
...
## <a name="docusign-migration-to-adobe-sign-for-partners-under-microsoft-partner-agreements-mpas"></a><a name="7"></a><span data-ttu-id="b3c5b-429">Migração do DocuSign para o Adobe Sign para os parceiros com MPAs (Contratos de Parceiro da Microsoft)</span><span class="sxs-lookup"><span data-stu-id="b3c5b-429">DocuSign migration to Adobe Sign for partners under Microsoft Partner Agreements (MPAs)</span></span> 

### <a name="categories"></a><span data-ttu-id="b3c5b-430">Categorias</span><span class="sxs-lookup"><span data-stu-id="b3c5b-430">Categories</span></span>

- <span data-ttu-id="b3c5b-431">Data: 15-01-2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-431">Date: 2021-01-15</span></span>
- <span data-ttu-id="b3c5b-432">Funcionalidades</span><span class="sxs-lookup"><span data-stu-id="b3c5b-432">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="b3c5b-433">Resumo</span><span class="sxs-lookup"><span data-stu-id="b3c5b-433">Summary</span></span>

<span data-ttu-id="b3c5b-434">A Microsoft fará a transição de todo o processamento de assinatura eletrônica do DocuSign para o Adobe Sign.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-434">Microsoft will be transitioning all electronic signature processing from DocuSign to Adobe Sign.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b3c5b-435">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="b3c5b-435">Impacted audience</span></span>

<span data-ttu-id="b3c5b-436">Parceiros CSP (Provedor de Soluções na Nuvem) indiretos e diretos que têm um MPA.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-436">Existing direct and indirect Cloud Solution Provider (CSP) partners under MPA.</span></span> <span data-ttu-id="b3c5b-437">Parceiros na Ucrânia, na Rússia e no Cazaquistão precisarão assinar de maneira física ou eletrônica a cláusula adicional anualmente.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-437">Partners in Ukraine, Russia, and Kazakhstan will be required to physically or electronically re-sign the Rider annually.</span></span>

### <a name="details"></a><span data-ttu-id="b3c5b-438">Detalhes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-438">Details</span></span>

<span data-ttu-id="b3c5b-439">Em fevereiro de 2021, a Microsoft iniciará a transição de todo o processamento de assinatura eletrônica do DocuSign para o Adobe Sign para parceiros CSP.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-439">In February 2021, Microsoft will begin transitioning all electronic signature processing from DocuSign to Adobe Sign for CSP partners.</span></span> 

<span data-ttu-id="b3c5b-440">Você deverá esperar uma transição sem problemas.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-440">You should expect a smooth transition.</span></span> <span data-ttu-id="b3c5b-441">Após a migração, você receberá um email de adobesign@adobesign.com, em vez da DocuSign, sempre que sua assinatura eletrônica for necessária.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-441">Upon migration, you will receive an email from adobesign@adobesign.com, instead of DocuSign, whenever your electronic signature is required.</span></span> <span data-ttu-id="b3c5b-442">Esse email fornecerá um link para a página da Web do Adobe Sign, em que você precisará assinar.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-442">This email will provide you with a link to the Adobe Sign web page where you will need to sign.</span></span> <span data-ttu-id="b3c5b-443">Parceiros da Microsoft não precisarão assinar novamente contratos existentes, somente Contratos de Canal futuros.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-443">Microsoft partners will not have to re-sign existing agreements, only future Channel Agreements.</span></span> 

<span data-ttu-id="b3c5b-444">Veja um exemplo de um email de solicitação de assinatura do Adobe Sign na [galeria de recursos](https://partner.microsoft.com/resources/detail/adobe-sign-signature-request-email-pdf).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-444">You can find an example of an Adobe Sign signature request email in [the resource gallery](https://partner.microsoft.com/resources/detail/adobe-sign-signature-request-email-pdf).</span></span> 

<span data-ttu-id="b3c5b-445">**Para ter a melhor experiência, não deixe de fazer o seguinte:**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-445">**For the best experience, make sure to do the following:**</span></span>

1. <span data-ttu-id="b3c5b-446">Adicione adobesign@adobesign.com à sua lista de remetentes seguros para evitar que emails dessa conta vão diretamente para a pasta de lixo eletrônico.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-446">Add adobesign@adobesign.com to your safe senders list to avoid emails from this account going directly into your junk email folder.</span></span>
2. <span data-ttu-id="b3c5b-447">Trabalhe com seu departamento de TI para:</span><span class="sxs-lookup"><span data-stu-id="b3c5b-447">Work with your IT department to:</span></span>
   - <span data-ttu-id="b3c5b-448">Atualizar o endereço de email adobesign@adobesign.com à lista de remetentes seguros para garantir que ele não seja incluído em nenhuma regra de phishing existente.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-448">Add the adobesign@adobesign.com email address to their safe senders list to ensure that it’s not included in any pre-established phishing rule.</span></span>
   - <span data-ttu-id="b3c5b-449">Atualizar as políticas de segurança existentes para garantir que todos os destinatários necessários possam assinar a documentação com sua licença empresarial do Adobe Sign.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-449">Update existing security policies to ensure that all required recipients can sign documentation under your Adobe Sign enterprise license.</span></span>

<span data-ttu-id="b3c5b-450">O Adobe Sign é a ESS (Solução de Assinatura Eletrônica) preferencial da Microsoft.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-450">Adobe Sign is Microsoft’s preferred Electronic Signature Solution (ESS).</span></span> <span data-ttu-id="b3c5b-451">A transição para o Adobe Sign garantirá uma experiência de assinatura eletrônica segura e eficiente que oferecerá maior valor para nossos clientes e parceiros.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-451">The transition to Adobe Sign will ensure a secure and efficient electronic signature experience that will deliver greater value to our customers and partners.</span></span>

<span data-ttu-id="b3c5b-452">Para saber mais sobre como assinar documentos eletronicamente e sobre a delegação de assinatura eletrônica, confira os seguintes **tutoriais**:</span><span class="sxs-lookup"><span data-stu-id="b3c5b-452">For additional information on how to electronically sign documents and electronic signature delegation, refer to the following **tutorials**:</span></span> 
- [<span data-ttu-id="b3c5b-453">Assinar um documento eletronicamente | Tutoriais do Adobe Sign</span><span class="sxs-lookup"><span data-stu-id="b3c5b-453">Electronically sign a document | Adobe Sign tutorials</span></span>](https://helpx.adobe.com/sign/how-to/adobe-for-signers.html?playlist=/ccx/v1/collection/product/sign/segment/designer/explevel/beginner/applaunch/continuinged/collection.ccx.js&ref=helpx.adobe.com)
- [<span data-ttu-id="b3c5b-454">Delegar alguém para assinar um documento | Tutoriais do Adobe Sign</span><span class="sxs-lookup"><span data-stu-id="b3c5b-454">Delegate someone else to sign a document | Adobe Sign tutorials</span></span>](https://helpx.adobe.com/sign/how-to/use-the-delegator-role.html?playlist=/ccx/v1/collection/product/sign/segment/designer/explevel/beginner/applaunch/orientation/collection.ccx.js&ref=helpx.adobe.com)

### <a name="next-steps"></a><span data-ttu-id="b3c5b-455">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="b3c5b-455">Next steps</span></span>

<span data-ttu-id="b3c5b-456">Compartilhe essas informações com os stakeholders apropriados da sua organização.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-456">Share this information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="b3c5b-457">Perguntas?</span><span class="sxs-lookup"><span data-stu-id="b3c5b-457">Questions?</span></span>

<span data-ttu-id="b3c5b-458">Em caso de dúvidas, entre em contato com o Centro de Operações Regionais usando a [CLT (Ferramenta de Log de Chamadas)](https://clt.partners.extranet.microsoft.com/CLT) ou no [Explore MS](https://www.explore.ms/).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-458">If you have any questions, contact your Regional Operations Center using the [Call Logging Tool (CLT)](https://clt.partners.extranet.microsoft.com/CLT) or at [Explore MS](https://www.explore.ms/).</span></span> <span data-ttu-id="b3c5b-459">Siga o processo padrão da CLT para que possamos resolver sua consulta o mais rápido possível.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-459">Follow the standard CLT process closely so that we can resolve your query as quickly as possible.</span></span>

_____________ 

## <a name="commercial-pricing-update-for-norwegian-krone"></a><a name="6"></a><span data-ttu-id="b3c5b-460">Atualização de preço comercial para coroa norueguesa</span><span class="sxs-lookup"><span data-stu-id="b3c5b-460">Commercial pricing update for Norwegian krone</span></span> 

### <a name="categories"></a><span data-ttu-id="b3c5b-461">Categorias</span><span class="sxs-lookup"><span data-stu-id="b3c5b-461">Categories</span></span>

- <span data-ttu-id="b3c5b-462">Data: 14-01-2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-462">Date: 2021-01-14</span></span>
- <span data-ttu-id="b3c5b-463">Ofertas/mercados</span><span class="sxs-lookup"><span data-stu-id="b3c5b-463">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b3c5b-464">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="b3c5b-464">Impacted audience</span></span>

<span data-ttu-id="b3c5b-465">Parceiros CSP que usam a coroa norueguesa.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-465">Cloud Solution Provider partners using the Norwegian krone.</span></span>

### <a name="details"></a><span data-ttu-id="b3c5b-466">Detalhes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-466">Details</span></span>

<span data-ttu-id="b3c5b-467">A partir de 1º de março de 2021, os preços em coroas noruegueses para software comercial local e serviços online serão alterados a fim de realinhá-los aos níveis de preço predominantes na região.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-467">From March 1, 2021, Norwegian krone prices for commercial on-premises software and online services will change to realign with prevailing pricing levels in the region.</span></span>
<span data-ttu-id="b3c5b-468">O comunicado completo está disponível somente para parceiros da Microsoft.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-468">The full announcement is available only to Microsoft partners.</span></span> <span data-ttu-id="b3c5b-469">[Conecte-se para acessar o comunicado completo](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-469">[Sign in to access the full announcement](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).</span></span>

_____________ 

## <a name="commercial-pricing-update-for-the-indian-rupee"></a><a name="5"></a><span data-ttu-id="b3c5b-470">Atualização de preços comerciais para INR</span><span class="sxs-lookup"><span data-stu-id="b3c5b-470">Commercial pricing update for the Indian rupee</span></span> 

### <a name="categories"></a><span data-ttu-id="b3c5b-471">Categorias</span><span class="sxs-lookup"><span data-stu-id="b3c5b-471">Categories</span></span>

- <span data-ttu-id="b3c5b-472">Data: 08/01/2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-472">Date: 2021-01-08</span></span>
- <span data-ttu-id="b3c5b-473">Ofertas/mercados</span><span class="sxs-lookup"><span data-stu-id="b3c5b-473">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b3c5b-474">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="b3c5b-474">Impacted audience</span></span>

<span data-ttu-id="b3c5b-475">Parceiros do CSP que atuam na Índia.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-475">CSP partners transacting in India.</span></span>

### <a name="details"></a><span data-ttu-id="b3c5b-476">Detalhes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-476">Details</span></span> 

<span data-ttu-id="b3c5b-477">A Microsoft está fazendo alterações na lista de preços em INR para alinhar os preços para software comercial e serviços online na Índia e na região asiática.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-477">Microsoft is making changes to the Indian rupee price list to align prices for commercial software and online services within India and the Asian region.</span></span>

<span data-ttu-id="b3c5b-478">O comunicado completo só está disponível para os parceiros da Microsoft.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-478">The full announcement is only available to Microsoft Partners.</span></span> <span data-ttu-id="b3c5b-479">[Faça logon para acessar o comunicado completo](https://partner.microsoft.com/resources/detail/price-update-indian-rupee.pdf).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-479">[Login to access the full announcement](https://partner.microsoft.com/resources/detail/price-update-indian-rupee.pdf).</span></span>

________________

## <a name="calling-plan-and-phone-system-updates-for-february-1-2021"></a><a name="4"></a><span data-ttu-id="b3c5b-480">Atualizações do Plano de Chamadas e do Sistema de Telefonia de 1º de fevereiro de 2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-480">Calling Plan and Phone System updates for February 1, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="b3c5b-481">Categorias</span><span class="sxs-lookup"><span data-stu-id="b3c5b-481">Categories</span></span>

- <span data-ttu-id="b3c5b-482">Data: 08/01/2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-482">Date: 2021-01-08</span></span>
- <span data-ttu-id="b3c5b-483">Ofertas/mercados</span><span class="sxs-lookup"><span data-stu-id="b3c5b-483">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="b3c5b-484">Resumo</span><span class="sxs-lookup"><span data-stu-id="b3c5b-484">Summary</span></span>

<span data-ttu-id="b3c5b-485">Uma oferta de complemento para Microsoft 365, que incluirá o Sistema de Telefonia, o Plano de Chamadas Nacionais e um Plano de Chamadas Nacionais independente, estará disponível em breve para países selecionados.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-485">An add-on offer to Microsoft 365, which will include Phone System and Domestic Calling Plan and a standalone Domestic Calling Plan, is coming soon to select countries.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b3c5b-486">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="b3c5b-486">Impacted audience</span></span>

<span data-ttu-id="b3c5b-487">Todos os parceiros que fazem transações pelo programa de CSP (Provedor de Soluções de Nuvem).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-487">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="b3c5b-488">Detalhes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-488">Details</span></span> 

<span data-ttu-id="b3c5b-489">A oferta no pacote do complemento para as ofertas do Microsoft 365 E1, E3 e E5 incluirá o Sistema de Telefonia e o Plano de Chamadas Nacionais.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-489">The add-on bundled offer to Microsoft 365 E1, E3, and E5 offers will include Phone System and Domestic Calling Plan.</span></span> <span data-ttu-id="b3c5b-490">Além disso, uma nova oferta de Plano de Chamadas Nacionais independente estará disponível apenas para o E5.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-490">In addition, a new standalone Domestic Calling Plan offer will be available for E5 only.</span></span> <span data-ttu-id="b3c5b-491">As novas ofertas estarão disponíveis somente para os clientes nos EUA, Porto Rico e Canadá. Para todos os outros países e regiões, os preços e SKUs independentes globais atuais continuam os mesmos.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-491">The new offers will be available to customers in the US, Puerto Rico, and Canada only; for all other countries and territories, the existing global standalone SKUs and pricing remain the same.</span></span> 

<span data-ttu-id="b3c5b-492">Essas ofertas estarão disponíveis para clientes comerciais, estudantes, docentes, de Nuvem da Comunidade Governamental (GCC) e de organizações sem fins lucrativos nos EUA, Porto Rico e Canadá.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-492">These offers will be available to Commercial, Student, Faculty, Government Community Cloud (GCC), and Nonprofit customers in the US, Puerto Rico, and Canada.</span></span> <span data-ttu-id="b3c5b-493">Os planos de chamadas não estão disponíveis em nenhum dos outros territórios dos EUA.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-493">Calling plans are not available in any of the other US territories.</span></span>

   |<span data-ttu-id="b3c5b-494">**Nome da oferta**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-494">**Offer name**</span></span>|<span data-ttu-id="b3c5b-495">**ID da oferta**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-495">**Offer ID**</span></span>|<span data-ttu-id="b3c5b-496">**ID do material**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-496">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="b3c5b-497">Microsoft Teams Calling Essentials para EUA e Canadá</span><span class="sxs-lookup"><span data-stu-id="b3c5b-497">Microsoft Teams Calling Essentials for US and Canada</span></span>|<span data-ttu-id="b3c5b-498">1ee81de6-4d8b-4cf1-b926-2fd2a774a4ca</span><span class="sxs-lookup"><span data-stu-id="b3c5b-498">1ee81de6-4d8b-4cf1-b926-2fd2a774a4ca</span></span>|<span data-ttu-id="b3c5b-499">8N2-00010</span><span class="sxs-lookup"><span data-stu-id="b3c5b-499">8N2-00010</span></span>|
   |<span data-ttu-id="b3c5b-500">Microsoft Teams Calling Essentials para EUA e Canadá (preços para equipes de organizações sem fins lucrativos)</span><span class="sxs-lookup"><span data-stu-id="b3c5b-500">Microsoft Teams Calling Essentials for US and Canada (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="b3c5b-501">0c2ece0d-39b7-40ec-8c08-87c2b6c75d62</span><span class="sxs-lookup"><span data-stu-id="b3c5b-501">0c2ece0d-39b7-40ec-8c08-87c2b6c75d62</span></span>|<span data-ttu-id="b3c5b-502">8N2-00011</span><span class="sxs-lookup"><span data-stu-id="b3c5b-502">8N2-00011</span></span>|
   |<span data-ttu-id="b3c5b-503">Microsoft Teams Calling Essentials para EUA e Canadá para docentes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-503">Microsoft Teams Calling Essentials for US and Canada for faculty</span></span>|<span data-ttu-id="b3c5b-504">b8baa3b8-8cc2-4f26-a212-7fbeb28e7895</span><span class="sxs-lookup"><span data-stu-id="b3c5b-504">b8baa3b8-8cc2-4f26-a212-7fbeb28e7895</span></span>|<span data-ttu-id="b3c5b-505">8N3-00003</span><span class="sxs-lookup"><span data-stu-id="b3c5b-505">8N3-00003</span></span>|
   |<span data-ttu-id="b3c5b-506">Microsoft Teams Calling Essentials para EUA e Canadá para estudantes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-506">Microsoft Teams Calling Essentials for US and Canada for students</span></span>|<span data-ttu-id="b3c5b-507">26956da8-eeb5-44e3-aa79-d36e0e42b930</span><span class="sxs-lookup"><span data-stu-id="b3c5b-507">26956da8-eeb5-44e3-aa79-d36e0e42b930</span></span>|<span data-ttu-id="b3c5b-508">8N3-00004</span><span class="sxs-lookup"><span data-stu-id="b3c5b-508">8N3-00004</span></span>|
   |<span data-ttu-id="b3c5b-509">Microsoft Teams Calling Essentials para EUA e Canadá para GCC</span><span class="sxs-lookup"><span data-stu-id="b3c5b-509">Microsoft Teams Calling Essentials for US and Canada for GCC</span></span>|<span data-ttu-id="b3c5b-510">7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1</span><span class="sxs-lookup"><span data-stu-id="b3c5b-510">7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1</span></span>|<span data-ttu-id="b3c5b-511">8N4-00002</span><span class="sxs-lookup"><span data-stu-id="b3c5b-511">8N4-00002</span></span>|
   |<span data-ttu-id="b3c5b-512">Plano de Chamadas Nacionais do Microsoft 365 para os EUA e Canadá</span><span class="sxs-lookup"><span data-stu-id="b3c5b-512">Microsoft 365 Domestic Calling Plan for US and Canada</span></span>|<span data-ttu-id="b3c5b-513">60d2919e-427a-46c9-bd03-89cbad27d53f</span><span class="sxs-lookup"><span data-stu-id="b3c5b-513">60d2919e-427a-46c9-bd03-89cbad27d53f</span></span>|<span data-ttu-id="b3c5b-514">TK2-00050</span><span class="sxs-lookup"><span data-stu-id="b3c5b-514">TK2-00050</span></span>|
   |<span data-ttu-id="b3c5b-515">Plano de Chamadas Nacionais do Microsoft 365 para docentes dos EUA e Canadá</span><span class="sxs-lookup"><span data-stu-id="b3c5b-515">Microsoft 365 Domestic Calling Plan for faculty for US and Canada</span></span>|<span data-ttu-id="b3c5b-516">602e7548-375b-4e01-bf79-a9a8b8ff16d4</span><span class="sxs-lookup"><span data-stu-id="b3c5b-516">602e7548-375b-4e01-bf79-a9a8b8ff16d4</span></span>|<span data-ttu-id="b3c5b-517">LM7-00006</span><span class="sxs-lookup"><span data-stu-id="b3c5b-517">LM7-00006</span></span>|
   |<span data-ttu-id="b3c5b-518">Plano de Chamadas Nacionais do Microsoft 365 para estudantes dos EUA e Canadá</span><span class="sxs-lookup"><span data-stu-id="b3c5b-518">Microsoft 365 Domestic Calling Plan for students for US and Canada</span></span>|<span data-ttu-id="b3c5b-519">1f4b4375-3185-40cf-b044-117fe3b102c6</span><span class="sxs-lookup"><span data-stu-id="b3c5b-519">1f4b4375-3185-40cf-b044-117fe3b102c6</span></span>|<span data-ttu-id="b3c5b-520">LM7-00007</span><span class="sxs-lookup"><span data-stu-id="b3c5b-520">LM7-00007</span></span>|
   |<span data-ttu-id="b3c5b-521">Plano de Chamadas Nacionais do Microsoft 365 para GCC dos EUA e Canadá</span><span class="sxs-lookup"><span data-stu-id="b3c5b-521">Microsoft 365 Domestic Calling Plan for GCC for US and Canada</span></span>|<span data-ttu-id="b3c5b-522">594ed84e-ddf8-4e40-9726-76c04bd29e3b</span><span class="sxs-lookup"><span data-stu-id="b3c5b-522">594ed84e-ddf8-4e40-9726-76c04bd29e3b</span></span>|<span data-ttu-id="b3c5b-523">LM9-00023</span><span class="sxs-lookup"><span data-stu-id="b3c5b-523">LM9-00023</span></span>|

### <a name="next-steps"></a><span data-ttu-id="b3c5b-524">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="b3c5b-524">Next steps</span></span>

- <span data-ttu-id="b3c5b-525">Compartilhe essas informações com os contatos relevantes em sua organização e entenda as oportunidades de venda adicional e cruzada.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-525">Share this information with the relevant contacts in your organization and understand the upsell and cross-sell opportunities.</span></span> 
- <span data-ttu-id="b3c5b-526">Examine a seção de recursos do [Guia do parceiro do Teams](https://aka.ms/teamscallingmeetingsguide).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-526">Review the resources section of the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide).</span></span>

_____________ 

## <a name="license-base-price-list-updates-for-january-2021"></a><a name="3"></a><span data-ttu-id="b3c5b-527">Atualizações da lista de preços baseada em licenças de janeiro de 2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-527">License-base price list updates for January 2021</span></span> 

### <a name="categories"></a><span data-ttu-id="b3c5b-528">Categorias</span><span class="sxs-lookup"><span data-stu-id="b3c5b-528">Categories</span></span>

- <span data-ttu-id="b3c5b-529">Data: 08/01/2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-529">Date: 2021-01-08</span></span>
- <span data-ttu-id="b3c5b-530">Ofertas/mercados</span><span class="sxs-lookup"><span data-stu-id="b3c5b-530">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="b3c5b-531">Resumo</span><span class="sxs-lookup"><span data-stu-id="b3c5b-531">Summary</span></span>

<span data-ttu-id="b3c5b-532">As listas de preços de janeiro e fevereiro para ofertas baseadas em licença foram atualizadas para corrigir determinados preços de lista incorretos.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-532">January and February price lists for license-based offers have been updated to correct certain incorrect list prices.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b3c5b-533">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="b3c5b-533">Impacted audience</span></span>

<span data-ttu-id="b3c5b-534">Todos os parceiros que fazem transações pelo programa de CSP (Provedor de Soluções de Nuvem).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-534">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="b3c5b-535">Detalhes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-535">Details</span></span> 

<span data-ttu-id="b3c5b-536">As listas de preços com base em licenças para janeiro e fevereiro de 2021 incluíam alguns preços de lista incorretos.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-536">The license-based price lists for January 2021 and February 2021 included a few incorrect list prices.</span></span> <span data-ttu-id="b3c5b-537">As ofertas e as moedas afetadas estão abaixo.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-537">The impacted offers and currencies are below.</span></span> <span data-ttu-id="b3c5b-538">O preço correto foi atualizado e disponibilizado a partir de 7 de janeiro de 2021 14h PST (Horário Padrão do Pacífico).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-538">The correct pricing was updated and available as of January 7, 2021 2PM PST (Pacific Standard Time).</span></span> 

   |<span data-ttu-id="b3c5b-539">**Nome da oferta**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-539">**Offer name**</span></span>|<span data-ttu-id="b3c5b-540">**ID da oferta**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-540">**Offer ID**</span></span>|<span data-ttu-id="b3c5b-541">**ID do material**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-541">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="b3c5b-542">Microsoft 365 E3</span><span class="sxs-lookup"><span data-stu-id="b3c5b-542">Microsoft 365 E3</span></span>|<span data-ttu-id="b3c5b-543">2b3b8d2d-10aa-4be4-b5fd-7f2feb0c3091</span><span class="sxs-lookup"><span data-stu-id="b3c5b-543">2b3b8d2d-10aa-4be4-b5fd-7f2feb0c3091</span></span>|<span data-ttu-id="b3c5b-544">AAA-35638</span><span class="sxs-lookup"><span data-stu-id="b3c5b-544">AAA-35638</span></span>| 
   |<span data-ttu-id="b3c5b-545">Microsoft 365 Business Basic</span><span class="sxs-lookup"><span data-stu-id="b3c5b-545">Microsoft 365 Business Basic</span></span>|<span data-ttu-id="b3c5b-546">bd938f12-058f-4927-bba3-ae36b1d2501c</span><span class="sxs-lookup"><span data-stu-id="b3c5b-546">bd938f12-058f-4927-bba3-ae36b1d2501c</span></span>|<span data-ttu-id="b3c5b-547">AAA-10624</span><span class="sxs-lookup"><span data-stu-id="b3c5b-547">AAA-10624</span></span>|

<span data-ttu-id="b3c5b-548">Moedas afetadas:</span><span class="sxs-lookup"><span data-stu-id="b3c5b-548">Currencies impacted:</span></span> 

- <span data-ttu-id="b3c5b-549">Os problemas de preço do Microsoft 365 E3 eram limitados apenas a estas moedas: JPY (iene [Japão]), GBP (libra esterlina), EUR (União Europeia) e AUD (dólar australiano).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-549">Microsoft 365 E3 price issues were limited to only these currencies: Japanese Yen (JPY), Great British Pound (GBP), European Union (EUR), Australian Dollar (AUD).</span></span> 
- <span data-ttu-id="b3c5b-550">Os problemas de preço do Microsoft 365 Business Basic eram limitados apenas ao US$ (dólar americano).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-550">Microsoft 365 Business Basic issues were limited to only United States Dollars (USD).</span></span> 

<span data-ttu-id="b3c5b-551">Os parceiros devem fazer referência às listas de preços prévias de janeiro e fevereiro disponíveis para encontrar os preços corretos.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-551">Partners should reference the currently available January and February preview price lists for the correct prices.</span></span> 

### <a name="next-steps"></a><span data-ttu-id="b3c5b-552">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="b3c5b-552">Next steps</span></span>

- <span data-ttu-id="b3c5b-553">Os parceiros devem baixar os arquivos de lista de preços mais recentes do Partner Center para obter os preços corrigidos de janeiro e fevereiro.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-553">Partners should download the latest price list files from the Partner Center to get the corrected January and February prices.</span></span> 
- <span data-ttu-id="b3c5b-554">Os administradores globais de locatários afetados que compraram assinaturas entre 1º e 6 de janeiro serão notificados por meio de um email do Partner Center antes do fim de janeiro com mais detalhes.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-554">Global administrators for impacted tenants who have purchased subscriptions between January 1 and January 6 will be notified via a Partner Center email before the end of January with more details.</span></span> 

________________
## <a name="deprecation-and-retirement-of-existing-get-and-put-qualification-apis-for-the-education-customer-validation-process-by-the-end-of-february-2021"></a><a name="2"></a><span data-ttu-id="b3c5b-555">Reprovação e desativação das APIs de Qualificação GET e PUT existentes para o processo de validação do cliente de Educação até o fim de fevereiro de 2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-555">Deprecation and retirement of existing GET and PUT Qualification APIs for the Education customer validation process by the end of February 2021</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b3c5b-556">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="b3c5b-556">Impacted audience</span></span>

<span data-ttu-id="b3c5b-557">Parceiros que vendem ofertas Acadêmicas por meio do programa Provedor de Soluções na Nuvem usando a API do Partner Center</span><span class="sxs-lookup"><span data-stu-id="b3c5b-557">Partners selling Academic offers through the Cloud Solution Provider program using the Partner Center API</span></span>

### <a name="details"></a><span data-ttu-id="b3c5b-558">Detalhes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-558">Details</span></span> 

<span data-ttu-id="b3c5b-559">Este é um acompanhamento dos aprimoramentos de API lançados em dezembro de 2020.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-559">This is a follow-up to the API enhancements released in December 2020.</span></span> <span data-ttu-id="b3c5b-560">Em dezembro de 2020, novas APIs de Qualificações GET e POST foram lançadas e, como resultado, as APIs de Qualificação GET e PUT antigas serão desativadas até o final de fevereiro de 2021.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-560">In December 2020 new GET and POST Qualifications APIs were released, and as a result the old GET and PUT Qualification APIs will be retired by the end of February 2021.</span></span> <span data-ttu-id="b3c5b-561">Nessa data, você precisará usar as novas APIs GET e POST do Partner Center para comprar ofertas de Educação.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-561">At that time, you will need to use the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span> 

### <a name="next-steps"></a><span data-ttu-id="b3c5b-562">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="b3c5b-562">Next steps</span></span>

- <span data-ttu-id="b3c5b-563">Se você ainda não fez isso, faça a atualização para as novas APIs a fim de realizar uma transição bem-sucedida e em tempo hábil.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-563">If you haven't already done so, update to the new APIs for a successful and timely transition.</span></span>
- <span data-ttu-id="b3c5b-564">Examine as novas alterações da API do Partner Center e o [Guia nos recursos de Preparação de Operações:  aprimoramentos do processo de validação do cliente de Educação do Partner Center](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/).</span><span class="sxs-lookup"><span data-stu-id="b3c5b-564">Review the new Partner Center API changes, and [Guide in the Operations Readiness resources:  Partner Center Education customer validation process enhancements](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/).</span></span>
- <span data-ttu-id="b3c5b-565">Compartilhe essas informações com as equipes apropriadas da sua organização e com seus revendedores para ajudá-los a se preparar para essas alterações.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-565">Share this information with the appropriate teams in your organization, and with your resellers, to help them prepare for these changes.</span></span>

_____________

## <a name="dynamics-365-offers-for-february-2021"></a><a name="1"></a><span data-ttu-id="b3c5b-566">Ofertas do Dynamics 365 para fevereiro de 2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-566">Dynamics 365 offers for February 2021</span></span>

### <a name="categories"></a><span data-ttu-id="b3c5b-567">Categorias</span><span class="sxs-lookup"><span data-stu-id="b3c5b-567">Categories</span></span>

- <span data-ttu-id="b3c5b-568">Data: 04/01/2021</span><span class="sxs-lookup"><span data-stu-id="b3c5b-568">Date: 2021-01-04</span></span>
- <span data-ttu-id="b3c5b-569">Ofertas</span><span class="sxs-lookup"><span data-stu-id="b3c5b-569">Offers</span></span>

### <a name="summary"></a><span data-ttu-id="b3c5b-570">Resumo</span><span class="sxs-lookup"><span data-stu-id="b3c5b-570">Summary</span></span>

<span data-ttu-id="b3c5b-571">As novas alterações da oferta do Dynamics 365 serão iniciadas em fevereiro de 2021.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-571">New Dynamics 365 offer changes will be launched in February 2021.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b3c5b-572">Público-alvo afetado</span><span class="sxs-lookup"><span data-stu-id="b3c5b-572">Impacted audience</span></span>

<span data-ttu-id="b3c5b-573">Parceiros que participam dos programas de incentivo de revendedor indireto, provedor indireto e parceiro de cobrança direta do CSP (Provedor de Soluções na Nuvem)</span><span class="sxs-lookup"><span data-stu-id="b3c5b-573">Partners participating in the Cloud Solution Provider (CSP) direct bill partner, indirect provider, and indirect reseller incentive programs</span></span>

### <a name="details"></a><span data-ttu-id="b3c5b-574">Detalhes</span><span class="sxs-lookup"><span data-stu-id="b3c5b-574">Details</span></span>

<span data-ttu-id="b3c5b-575">A Microsoft está anunciando novas alterações da oferta do Dynamics 365, que serão iniciadas em fevereiro de 2021 para:</span><span class="sxs-lookup"><span data-stu-id="b3c5b-575">Microsoft is announcing upcoming new Dynamics 365 offer changes that will be launched in February 2021 for:</span></span>

- <span data-ttu-id="b3c5b-576">Resposta Adicional da Opinião do Cliente para o Dynamics 365</span><span class="sxs-lookup"><span data-stu-id="b3c5b-576">Dynamics 365 Customer Voice Additional Response</span></span>
- <span data-ttu-id="b3c5b-577">Fim da Vida Útil do Dynamics 365 Customer Service Insights</span><span class="sxs-lookup"><span data-stu-id="b3c5b-577">Dynamics 365 Customer Service Insights End of Life</span></span>
- <span data-ttu-id="b3c5b-578">Alteração das IDs da Oferta de Migração do Dynamics 365 Cloud AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-578">Dynamics 365 Cloud AX Migration Offer IDs change</span></span>

<span data-ttu-id="b3c5b-579">**Resposta Adicional da Opinião do Cliente para o Dynamics 365**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-579">**Dynamics 365 Customer Voice Additional Response**</span></span>

<span data-ttu-id="b3c5b-580">Em 1º de fevereiro de 2021, a Microsoft criará uma oferta de "Resposta Adicional" com direito a mil respostas para substituir a oferta existente de duas mil respostas de pesquisa, cujo fim da venda será em 1º de fevereiro de 2021.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-580">On February 1, 2021, Microsoft will create a new "Additional Response" offer with 1-K response entitlement to replace the existing offer with 2-K Survey Responses, the end of sale of which will be on February 1, 2021.</span></span>

<span data-ttu-id="b3c5b-581">Confira a guia "Resposta Adicional da Opinião do Cliente" no [documento do Excel Ofertas do Dynamics CSP – Fevereiro de 2021](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) para obter os detalhes do SKU.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-581">See the "Customer Voice Addl Resp" tab in the [Dynamics CSP Offers-February 2021 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) for the SKU details.</span></span> <span data-ttu-id="b3c5b-582">Acesse a [home page da Opinião do Cliente para o Microsoft Dynamics 365](https://dynamics.microsoft.com/customer-voice/overview/) para obter mais informações.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-582">View the [Microsoft Dynamics 365 Customer Voice Home Page](https://dynamics.microsoft.com/customer-voice/overview/) for more information.</span></span>

<span data-ttu-id="b3c5b-583">**Fim da Vida Útil do Dynamics 365 Customer Service Insights**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-583">**Dynamics 365 Customer Service Insights End of Life**</span></span>

<span data-ttu-id="b3c5b-584">Em 1º de fevereiro de 2021, os seguintes produtos serão alterados para o fim da vida útil:</span><span class="sxs-lookup"><span data-stu-id="b3c5b-584">On February 1, 2021, the following products will be changed to end-of-life:</span></span>

- <span data-ttu-id="b3c5b-585">Dynamics 365 Customer Service Insights (incluindo "Casos Adicionais")</span><span class="sxs-lookup"><span data-stu-id="b3c5b-585">Dynamics 365 Customer Service Insights (including "Additional Cases")</span></span>
- <span data-ttu-id="b3c5b-586">Agente Virtual do Dynamics 365 para Serviço de Atendimento ao Consumidor</span><span class="sxs-lookup"><span data-stu-id="b3c5b-586">Dynamics 365 Virtual Agent for Customer Service</span></span>

<span data-ttu-id="b3c5b-587">A experiência autônoma do "Customer Service Insights" está migrando para o "Dynamics 365 Customer Service", no qual os clientes podem encontrar as mesmas funcionalidades profundamente incorporadas às experiências de serviço de atendimento ao consumidor.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-587">The "Customer Service Insights" standalone experience is moving into "Dynamics 365 Customer Service", where customers can find the same capabilities deeply embedded in the customer service experiences.</span></span>  

<span data-ttu-id="b3c5b-588">Confira a guia "Customer Service Insights" no [documento do Excel Ofertas do Dynamics CSP – Fevereiro de 2021](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) para obter os detalhes do SKU.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-588">See the "Customer Service Insights" tab in the [Dynamics CSP Offers-February 2021 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) for the SKU details.</span></span> <span data-ttu-id="b3c5b-589">Acesse a [home page do Microsoft Dynamics Customer Service](https://dynamics.microsoft.com/customer-service/overview/) para obter mais informações.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-589">Visit the [Microsoft Dynamics Customer Service Home Page](https://dynamics.microsoft.com/customer-service/overview/) for more information.</span></span>

<span data-ttu-id="b3c5b-590">**IDs da oferta de migração do Dynamics 365 Cloud AX**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-590">**Dynamics 365 Cloud AX migration offer IDs**</span></span>

<span data-ttu-id="b3c5b-591">Esses SKUs foram removidos da lista final de preços de 1º de janeiro de 2021 e não estarão disponíveis para pedidos no momento.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-591">These SKUs have been removed from the January 1, 2021 final price list and will not be available to order at this time.</span></span> 

   |<span data-ttu-id="b3c5b-592">**Nome da oferta**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-592">**Offer name**</span></span>|<span data-ttu-id="b3c5b-593">**ID da oferta**</span><span class="sxs-lookup"><span data-stu-id="b3c5b-593">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="b3c5b-594">Programa de Migração do Dynamics 365 Finance for AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-594">Dynamics 365 Finance for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-595">7fbd1115-a4c1-4cf9-b881-40c4187ca581</span><span class="sxs-lookup"><span data-stu-id="b3c5b-595">7fbd1115-a4c1-4cf9-b881-40c4187ca581</span></span>|
   |<span data-ttu-id="b3c5b-596">Programa de Migração do Dynamics 365 Supply Chain Management for AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-596">Dynamics 365 Supply Chain Management for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-597">a3c62c0e-4f8a-4fc9-a47e-dec3310529d0</span><span class="sxs-lookup"><span data-stu-id="b3c5b-597">a3c62c0e-4f8a-4fc9-a47e-dec3310529d0</span></span>|
   |<span data-ttu-id="b3c5b-598">Programa de Migração do Dynamics 365 Commerce for AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-598">Dynamics 365 Commerce for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-599">97e98de6-24a8-4282-bad6-9d1a874e90a4</span><span class="sxs-lookup"><span data-stu-id="b3c5b-599">97e98de6-24a8-4282-bad6-9d1a874e90a4</span></span>|
   |<span data-ttu-id="b3c5b-600">Anexo do Dynamics 365 Finance à Oferta Base Qualificada do Dynamics 365 para o Programa de Migração do AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-600">Dynamics 365 Finance Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-601">69d789e8-1e93-4dee-86b2-3ddfb03c08b9</span><span class="sxs-lookup"><span data-stu-id="b3c5b-601">69d789e8-1e93-4dee-86b2-3ddfb03c08b9</span></span>|
   |<span data-ttu-id="b3c5b-602">Anexo do Dynamics 365 Supply Chain Management à Oferta Base Qualificada do Dynamics 365 para o Programa de Migração do AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-602">Dynamics 365 Supply Chain Management Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-603">c897adce-2964-4d24-abc3-7f7ad4b6a80d</span><span class="sxs-lookup"><span data-stu-id="b3c5b-603">c897adce-2964-4d24-abc3-7f7ad4b6a80d</span></span>|
   |<span data-ttu-id="b3c5b-604">Anexo do Dynamics 365 Commerce à Oferta Base Qualificada do Dynamics 365 para o Programa de Migração do AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-604">Dynamics 365 Commerce Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-605">ba1fe561-cfda-405a-a25d-ecda3bd3cba7</span><span class="sxs-lookup"><span data-stu-id="b3c5b-605">ba1fe561-cfda-405a-a25d-ecda3bd3cba7</span></span>|
   |<span data-ttu-id="b3c5b-606">Dynamics 365 Operations – Atividade para o Programa de Migração do AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-606">Dynamics 365 Operations – Activity for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-607">177e954e-1fff-4941-8967-55a47e36e1ce</span><span class="sxs-lookup"><span data-stu-id="b3c5b-607">177e954e-1fff-4941-8967-55a47e36e1ce</span></span>|
   |<span data-ttu-id="b3c5b-608">Dynamics 365 Operations – Dispositivo para o Programa de Migração do AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-608">Dynamics 365 Operations – Device for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-609">8c8b7c8f-cb3a-4737-8319-1752938c7be3</span><span class="sxs-lookup"><span data-stu-id="b3c5b-609">8c8b7c8f-cb3a-4737-8319-1752938c7be3</span></span>|
   |<span data-ttu-id="b3c5b-610">Membros da Equipe do Dynamics 365 para o Programa de Migração do AX</span><span class="sxs-lookup"><span data-stu-id="b3c5b-610">Dynamics 365 Team Members for AX Migration Program</span></span>|<span data-ttu-id="b3c5b-611">1eb3ad0b-9de3-419d-8bfe-0d61bdd945b2</span><span class="sxs-lookup"><span data-stu-id="b3c5b-611">1eb3ad0b-9de3-419d-8bfe-0d61bdd945b2</span></span>|

### <a name="next-steps"></a><span data-ttu-id="b3c5b-612">Próximas etapas</span><span class="sxs-lookup"><span data-stu-id="b3c5b-612">Next steps</span></span>

<span data-ttu-id="b3c5b-613">Examine os recursos relacionados a este tópico e compartilhe-os com os stakeholders apropriados da sua organização.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-613">Review the resources about this topic and share them with the appropriate stakeholders in your organization.</span></span> 

### <a name="questions"></a><span data-ttu-id="b3c5b-614">Perguntas?</span><span class="sxs-lookup"><span data-stu-id="b3c5b-614">Questions?</span></span>

<span data-ttu-id="b3c5b-615">Em caso de dúvidas adicionais sobre essas ofertas, confira as comunidades relevantes no Yammer.</span><span class="sxs-lookup"><span data-stu-id="b3c5b-615">For any further questions about these offers, check your relevant Yammer communities.</span></span>
