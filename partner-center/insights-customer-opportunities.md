...
3. Clustering
   ...
   A guia **modelo** de propensão nas pastas de trabalho CloudAscent compartilha a propensão e a receita de espaço em branco estimada. Para definir o clustering de ajuste e intenção, percorreremos as seguintes etapas:
      ...
      1. usando modelos de ML, primeiro calculamos a pontuação de ajuste do cliente e a pontuação de intenção em uma escala de 100.  as pontuações exatas variarão com base em modelos de ML.  Pontuação de exemplo abaixo:
...
EOS compartilha os clientes de fim de serviço (EOS) para o Win 7, Office 2010, SQL Server e Windows Server. Os dados de EOS são extraídos da MS Sales e sobrepostos com a modelagem de propensão CloudAscent, quando disponível. Os dados de EOS residem no trabalho moderno e nas atividades de vendas do Azure.
