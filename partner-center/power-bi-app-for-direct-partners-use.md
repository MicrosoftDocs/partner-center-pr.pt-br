...
-  **Rotatividade (últimos 30 dias)**: Clientes sem qualquer assinatura "ativo", "cortesia" ou "desabilitadas"
...
- **Status da assinatura**:
    ...
    - Ativo: Assinaturas com estado "ativo" ou "cortesia"

    - Suspenso: Assinaturas com estado "desabilitado"

    - Provisionamento cancelado: Assinaturas com status "provisionamento cancelado" ou "expirado"
...
-  **Total de assinaturas**: Assinaturas com status "ativo", "cortesia" ou "desabilitado"
