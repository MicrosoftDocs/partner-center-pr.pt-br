...
- [<span data-ttu-id="21985-112">Guia de referência de implantação do AutoPilot</span><span class="sxs-lookup"><span data-stu-id="21985-112">Autopilot deployment reference guide</span></span>](http://assetsprod.microsoft.com/autopilot-deployment-program-reference-guide-csp.docx)  
