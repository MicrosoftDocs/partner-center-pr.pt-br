...
As seções a seguir descrevem nosso processo de pagamento para transações **Enterprise Agreement** **e Contrato de Cliente da Microsoft ou CSP.**

### <a name="transactions-when-customer-has-an-enterprise-agreement"></a>Transações quando o cliente tem um Enterprise Agreement
...
### <a name="transactions-when-customer-has-a-microsoft-customer-agreement-or-csp"></a>Transações quando o cliente tem um contrato de cliente ou CSP da Microsoft
...
De acordo com o processo de pagamento articulado aqui, a Microsoft pode já ter pago os fundos para os editores (você) que, por fim, não podem ser coletados. Portanto, temos um processo para reconciliar esses valores.
...
| É provável que o editor seja notificado sobre a ressarção | 1/7/2021 | - |
| O cliente recebe um aviso de encerramento | 2/1/2021 | Nenhum |
| O processo de coleta termina/os fundos são gravados | 2/15/2021 | Notificação por email enviada ao editor de que os fundos foram gravados. |
| O pagamento é deduzido | 01/03/2021 | O publicador verá uma transação negativa Partner Center instrução de pagamento |
| O pagamento é retido | 3/15/2021 | Os pagamentos futuros serão mostrados na Partner Center de pagamento. O publicador não receberá o pagamento até que o saldo não seja mais negativo.  |
|||
