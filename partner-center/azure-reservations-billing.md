...
Para acessar faturas de cobrança única e arquivos de reconciliação, selecione **cobrança** no Partner Center e selecione **uma vez**. 
...
**Lista discriminada de encargos de uso único**
